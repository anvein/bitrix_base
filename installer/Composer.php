...
namespace anvein\bitrix_base\installer;
...
class Composer
{
    ...
    protected static function getLibraryFolder(Event $event)
    {
        ...
        foreach ($packages as $package) {
            if ($package->getName() === 'anvein/bitrix_base') {
                $srcFolder = realpath(rtrim($installationManager->getInstallPath($package), '/') . '/anvein.base');
                break;
            }
        }
